  ...
  const buildAccountQuestion = (accountType: AccountType): QuestionCollection => [
    {
      ...
      message:
        `Do you need to generate a new ${accountType} account? If you choose "yes", the ${accountType} account will ` +
        'be autogenerated for you. Otherwise, you will be asked to specify the private key of an existing account: ',
      default: false,
    },
    {
      type: 'confirm',
